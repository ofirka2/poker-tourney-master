  ...
  const getNavItems = () => {
    if (tournamentId) {
      ...
      return [
        ...
        { path: `/tournaments/${tournamentId}/dashboard`, label: "Dashboard", icon: LayoutDashboard },
        { path: `/tournaments/${tournamentId}/timer`, label: "Timer", icon: Timer },
        { path: `/tournaments/${tournamentId}/players`, label: "Players", icon: Users },
        { path: `/tournaments/${tournamentId}/tables`, label: "Tables", icon: LayoutGrid },
        { path: `/tournaments/${tournamentId}/setup`, label: "Setup", icon: Settings }
      ];
    } else {
      // General navigation (when no tournament is selected)
      return [
        { path: "/", label: "Home", icon: Home },
        { path: "/tournament", label: "Tournament Menu", icon: LayoutDashboard },
      ];
    }
  };
